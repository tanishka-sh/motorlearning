...
expName = 'Motor Learning Sequence Task'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Tanishka\\OneDrive\\Documents\\2. Courses\\PSY310\\Experiments\\T4_Motor Learning Sequence\\Motor Learning Sequence Task_lastrun.py',
